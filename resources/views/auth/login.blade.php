...
<style type="text/css">
    ...
    html{
/* //cambienado  el  imagen de fondo de la pagina  */
    background: url('images/consultorioFONDO.jpg') no-repeat center center;
...
<body>
    ...
    <form class="login" method="post" name="login" method="POST" action="{{ route('login') }}">
        {{ csrf_field() }}
        {{-- <h2>ODONTOLOGIA-SONRIE  <img src="{{ asset('images/icono.svg') }}" width="30"> </h2> --}}
        {{-- modificado de logotc por s.png --}}
        <img src="{{ asset('images/s.png') }}" width="65%"> 
