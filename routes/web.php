...
}); //encargado de recibir todas la petiviones que se hace en la aplicación


Auth::routes();

Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home'); // El GET  es cuando hacemos clic en un enclace y nose redirije  hacia alguna pagina
...
Route::post('/borrarlista',[App\Http\Controllers\EspecialidadController::class, 'borrarLista'])->name('borrar.lstespecialidad'); //  E l POST es cuando hacemos una peticion a un formulario o enviamos informaion y no queremos q la informacion sea visible
